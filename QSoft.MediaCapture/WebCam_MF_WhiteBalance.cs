...
namespace QSoft.MediaCapture
{
    ...
    public class CAMVideoProcAmp
    {
        public long Max { private set; get; }
        public long Min { private set; get; }
        public long Step { private set; get; }
        public CAMVideoProcAmp(IMFCaptureSource capturesource)
        {
            capturesource.GetCaptureDeviceSource(MF_CAPTURE_ENGINE_DEVICE_TYPE.MF_CAPTURE_ENGINE_DEVICE_TYPE_VIDEO, out var mediasource);
            var videoprocamp = mediasource as IAMVideoProcAmp;
            //videoprocamp.GetRange()
        }
    }
}
